import java.util.*;
public class Fate_OfRashi {

	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		
		System.out.println("Enter your Zodiac sign ☯");
		String rashi = sc.nextLine().toLowerCase();		
		
		switch(rashi) {
			case "aries":
				System.out.println("Career: Opportunities for advancement may arise, particularly in the second half of the year.\r\n"
				...
				break;
			case "taurus":
				System.out.println("Career: Stability and gradual progress in career matters can be expected.\r\n"
				...
				break;
			case "gemini":
				System.out.println("Career: Opportunities for networking and communication may lead to career advancements.\r\n"
				...
				break;
			case "cancer":
				System.out.println("Career: Stability and gradual progress are likely in career matters.\r\n"
				...
				break;
			case "leo":
				System.out.println("Career: Opportunities for leadership and recognition may arise.\r\n"
				...
				break;
			case "virgo":
				System.out.println("Career: Detail-oriented work may lead to recognition and advancement.\r\n"
				...
				break;
			case "libra":
				System.out.println("Career: Opportunities for diplomacy and collaboration may lead to career advancements.\r\n"
				...
				break;
			case "scorpio":
				System.out.println("Career: Opportunities for transformation and regeneration may lead to significant career shifts.\r\n"
				...
				break;
			case "sagittarius":
				System.out.println("Career: Opportunities for adventure and expansion may lead to career growth.\r\n"
				...
				break;
			case "capricorn":
				System.out.println("Career: Opportunities for discipline and hard work may lead to steady career progress.\r\n"
				...
				break;
			case "aquarius":
				System.out.println("Career: Hard work may lead to opportunities for promotion, with potential for job switching between August and October.\r\n"
				...
				break;
			case "pisces":
				System.out.println("Career: Opportunities for creativity and intuition may lead to career success.\r\n"
